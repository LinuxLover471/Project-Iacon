    ...
    if [[ -z ${de_choice} || ${de_choice} == "y" ]]; then
        ...
        select de_type in "KDE" "XFCE" "Gnome" "i3"; do
            ...
            "i3")
                ...
                de_pkg="i3 polybar picom dunst rofi rofi-calc ly numlockx xorg-xrdb xorg-xauth lutris alacritty nnn neovim xsel feh thunar polkit-gnome gvfs gvfs-mtp ark thunar-archive-plugin tumbler redshift inter-font ttf-fira-code ttf-firacode-nerd noto-fonts-emoji"
                break 2
                ;;
            *)
                echo "Please provide a valid input."
